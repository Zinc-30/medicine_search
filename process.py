...
class ProcessThread(threading.Thread):
    ...
    def run(self):
        ...
        try: 
            ...
            self._socket.sendall(("F%s" % errMsg)) #异常信息返回
            self._socket.close()
            return
